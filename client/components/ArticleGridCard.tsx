      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow h-full flex flex-col">
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between pt-2">
            <div className="flex items-center gap-2 text-gray-600 text-sm leading-5">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
            ...
            <Link
              ...
              className="flex items-center gap-1 text-blue-600 text-sm leading-5 hover:text-blue-700 transition-colors"
            >
              <span>Read More</span>
              <svg
                width="12"
